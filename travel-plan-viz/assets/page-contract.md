...
const trip = {
  ...
  disclaimer: "航班、酒店、门票、营业时间、活动等信息为基于公开资料的建议，可能与实时情况有出入，请务必在官方/订票订房 App 上核实后再预订或前往。",
...
- 每趟行程用不同配色以便区分。
- 航班/酒店/门票/营业时间/活动尽量基于公开资料给真实可信信息，但价格与时间均为**参考**、可能变动，**必须**展示免责声明（第 5 区块）引导用户核实。
